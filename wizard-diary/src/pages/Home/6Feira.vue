              ...
              <md-table visible="userVisible"  md-card>
               <md-table v-model="contratos.contratos" md-sort="name" md-sort-order="asc" md-card>
                ...
                <!-- <md-table-row v-for="item in users.users" :key="item.id"> -->
                  <md-table-row slot="md-table-row" slot-scope="{ item }" v-if="(item.dia_semana == 'sexta') && item.professor == 'Tanurio' && item.horario === '08:00-10:00'">
            ...
            <div style="marginTop: 10px">
              <md-table visible="userVisible"  md-card>
                <md-table v-model="contratos.contratos" md-sort="name" md-sort-order="asc" md-card>
                  ...
                  <!-- <md-table-row v-for="item in users.users" :key="item.id"> -->
                  <md-table-row  slot="md-table-row" slot-scope="{ item }" v-if="item.dia_semana == 'sexta' && item.professor == 'carla' && item.horario === '08:00-10:00'">
                    <md-table-cell  md-label="id" md-sort-by="id" md-numeric>{{item.id}}</md-table-cell>
                    <md-table-cell md-label="Aluno" md-sort-by="name">{{item.alunos.name}}</md-table-cell>
                    <md-table-cell md-label="Curso" md-sort-by="curso">{{item.curso}}</md-table-cell>
                    <md-table-cell md-label="Livro" md-sort-by="livro">{{item.livro}}</md-table-cell>
            ...
            <div style="marginTop: 10px">
              <md-table visible="userVisible"  md-card>
                <md-table v-model="contratos.contratos" md-sort="name" md-sort-order="asc" md-card>
                  ...
                  <!-- <md-table-row v-for="item in users.users" :key="item.id"> -->
                  <md-table-row  slot="md-table-row" slot-scope="{ item }" v-if="item.dia_semana == 'sexta' && item.professor == 'rafaela' && item.horario === '08:00-10:00'">
                    <md-table-cell  md-label="id" md-sort-by="id" md-numeric>{{item.id}}</md-table-cell>
                    <md-table-cell md-label="Aluno" md-sort-by="name">{{item.alunos.name}}</md-table-cell>
                    <md-table-cell md-label="Curso" md-sort-by="curso">{{item.curso}}</md-table-cell>
                    <md-table-cell md-label="Livro" md-sort-by="livro">{{item.livro}}</md-table-cell>
            ...
            <div style="marginTop: 10px">
              <md-table visible="userVisible"  md-card>
                <md-table v-model="contratos.contratos" md-sort="name" md-sort-order="asc" md-card>
                  ...
                  <!-- <md-table-row v-for="item in users.users" :key="item.id"> -->
                  <md-table-row  slot="md-table-row" slot-scope="{ item }" v-if="item.dia_semana == 'sexta' && item.professor == 'julia' && item.horario === '08:00-10:00'">
                    <md-table-cell  md-label="id" md-sort-by="id" md-numeric>{{item.id}}</md-table-cell>
                    <md-table-cell md-label="Aluno" md-sort-by="name">{{item.alunos.name}}</md-table-cell>
                    <md-table-cell md-label="Curso" md-sort-by="curso">{{item.curso}}</md-table-cell>
                    <md-table-cell md-label="Livro" md-sort-by="livro">{{item.livro}}</md-table-cell>
